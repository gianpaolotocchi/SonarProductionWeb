...
const SliderDragDropAutoScrollX = () => {
  ...
  const autoScroll = () => {
    ...
    const cardWidth = sliderRef.current.querySelector(".card").offsetWidth;
    currentTranslateXRef.current -= 0.5; // Regola la velocità dello scroll
  ...
  const handleStart = (e) => {
    ...
    stopAutoScroll(); // Ferma l'autoscroll mentre l'utente interagisce
...
export default SliderDragDropAutoScrollX;
